...
set(CHERI_FLAGS "-march=morello -mabi=purecap --target=aarch64-linux-musl_purecap --sysroot=${SYSROOT_DIR} -stdlib=libc++ -nostdlib++ -unwindlib=libunwind -gdwarf-4")
set(CHERI_FLAGS "${CHERI_FLAGS} -isystem ${RUNTIMES_DIR}/include/c++/v1 -I${RUNTIMES_DIR}/include")
set(CHERI_FLAGS "${CHERI_FLAGS} -fno-omit-frame-pointer -funwind-tables -g -gstrict-dwarf")
