...
int VADD_RedisCommand(RedisModuleCtx *ctx, RedisModuleString **argv, int argc) {
    ...
    if (cas) {
        ...
        targ[0] = bc;
        targ[1] = vset;
        targ[2] = (void*)(uintptr_t)vset->id;
        targ[3] = vec;
        targ[4] = val;
        targ[5] = NULL; // Used later for insertion context.
        targ[6] = (void*)(uintptr_t)ef;
        targ[7] = attrib;
...
int VSIM_RedisCommand(RedisModuleCtx *ctx, RedisModuleString **argv, int argc) {
    ...
    if (threaded_request) {
        ...
        targ[1] = vset;
        targ[2] = vec;
        targ[3] = (void*)(uintptr_t)count;
        targ[4] = RedisModule_Alloc(sizeof(float));
        *((float*)targ[4]) = epsilon;
        targ[5] = (void*)(uintptr_t)withscores;
        targ[6] = (void*)(uintptr_t)withattribs;
        targ[7] = (void*)(uintptr_t)ef;
        targ[8] = (void*)filter_expr;
        targ[9] = (void*)(uintptr_t)filter_ef;
        targ[10] = (void*)(uintptr_t)ground_truth;
        RedisModule_BlockedClientMeasureTimeStart(bc);
        vset->thread_creation_pending++;
