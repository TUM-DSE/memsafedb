...
1. **Copy Data**  
    ...
    ```bash
    python scripts/main.py --user <username> --host <hostname> copy
    ```
2. **Build Data Structure**  
    ...
    ```bash
    python scripts/main.py --user <username> --host <hostname> build --datastructure <datastructure_name>
    ```
...
3. **Analyse Data Structure**  
    ...
    ```bash
    python scripts/main.py --user <username> --host <hostname> analyse --datastructure <datastructure_name>
    ```
